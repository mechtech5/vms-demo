...
{   
    public function up()
    {
        ...
        Schema::create('vch_mast', function (Blueprint $table) {
            ...
            $table->string('reg_chassis_no',20)->nullable();
            $table->string('reg_engine_no',20)->nullable();
            ...
            $table->tinyInteger('pur_free_srv')->nullable();
            $table->tinyInteger('pur_duplicate_key')->nullable();
            $table->unsignedInteger('pur_free_srv_count')->nullable();
            ...
            $table->unsignedInteger('buyer_city')->nullable();
            ...
            $table->unsignedInteger('eng_cylinder_count')->nullable();
