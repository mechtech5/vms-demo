        ...
        <div class="box box-color orange box-condensed box-bordered">
          <div class="box-title">
            ...
            <div id="add-city-form">
             <form enctype="multipart/form-data" class="well form-horizontal" method="post" action="{{route('agent.store')}}">
              {{csrf_field()}}
                 <div class="card-body " >
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-xl-12" id="mytable1">
		                    ...
		                    <div class="row">
		                        ...
		                        <div class="col-md-6 col-xl-6 mt-2">
	                                ...
	                                <input id="ins_policy_no" class="form-control" name="agent_email" value="{{old('agent_email')}}" > 
	                                @error('agent_email')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
		                    ...
		                    <div class="row">    
		                        <div class="col-md-12 col-xl-12 mt-2">
	                                ...
	                                <textarea id="ins_policy_no" checked="true"  class="form-control" name="agent_address" value="{{old('agent_address')}}" ></textarea> 
	                                @error('agent_address')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
