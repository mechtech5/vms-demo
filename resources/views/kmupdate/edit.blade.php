        ...
        <div class="box box-color orange box-condensed box-bordered">
          <div class="box-title">
            ...
            <div id="add-city-form">
             <form class="well form-horizontal" method="post" action="{{route('kmupdate.update',$data->id)}}">
              {{csrf_field()}}
              @method('PATCH')
                 <div class="card-body " >
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-xl-12" id="mytable1">
                        	...
                        	<div class="col-md-4 col-xl-4 mt-2">
		                       ...
		                       <select name="vch_id" class="selectpicker form-control">
		                            ...
		                            @foreach($vehicle as $vehicles)
		                               <option value="{{$vehicles->id}}" {{$vehicles->id == $data->vch_id ? 'seletced':''}}>{{$vehicles->vch_no}}</option>
		                            @endforeach     
		                        </select>
                            ...
                            <div class="col-md-4 col-xl-4 mt-2">
                                ...
                                @error('reading')
		                         ...
		                         @enderror
                                <input id="vehicle_no" class="form-control" name="reading" value="{{old('reading') ?? $data->reading}}" > 
                             ...
                             <div class="col-md-4 col-xl-4 mt-2">
                                ...
                                @error('date')
		                         ...
		                         @enderror
                                <input class="form-control datepicker" type="text" readonly="true" name="date" value="{{old('date') ?? $data->date}}">
