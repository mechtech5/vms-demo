      ...
      <div class="col-sm-12">
        <div class="box box-color orange box-condensed box-bordered">
          <div class="box-title">
            ...
            <form enctype="multipart/form-data" class="well form-horizontal" method="post" action="{{route('rcdetails.update',$data->id)}}">
              {{csrf_field()}}
              @method('PATCH')
                 <div class="card-body " >
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-xl-12" id="mytable1">
                        	<div class="row">
				                ...
				                <div class="col-md-4 col-xl-4 mt-2">
		                                ...
		                                name="hypothecation_agreement" value="{{old('hypothecation_agreement') ?? $data->hypothecation_agreement}}" > 
	                            ...
	                            <div class="col-md-4 col-xl-4 mt-2">
	                                ...
	                                <input id="vehicle_no" class="form-control" name="rc_no" value="{{old('rc_no') ?? $data->rc_no}}" > 
	                                @error('rc_no')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
	                            ...
	                            <div class="col-md-4 col-xl-4 mt-2">
	                                ...
	                                <input id="email" name="rc_amt" class="form-control" value="{{old('rc_amt') ?? $data->rc_amt}}">
	                                 @error('rc_amt')
