          ...
          <div class="col-sm-4 col-md-4">
           <form id="target" class="pull-right" action="{{ route('pucdetails.import') }}" method="POST" enctype="multipart/form-data">
               ...
               <div class="file btn btn-inverse"><i class="fas fa-file-download"></i>
                ...
                <a class="btn btn-inverse" href="{{ route('pucdetails.export') }}"><i style="margin-right: 5px; " class="fas fa-file-import"></i></i>Export Bulk Data</a>
                <a class="btn btn-inverse" href="{{route('pucdetails.download') }}"><i style="margin-right: 5px; " class="fas fa-file-import"></i></i>Format</a>
              ...
              @php ($vch_no = \App\vehicle_master::find($pucdetails->vch_id))            
                <tr>
                  ...
                  <td style="width:10%; text-align:center;">
                    <a href="{{route('pucdetails.edit',$pucdetails->id)}}" runat="server" class="btn btn-success" rel="tooltip" title="" data-original-title="Edit"><i class="fa fa-edit"></i></a>
                    <a onclick="javascript:return confirm('Do You Really Want To Delete This?');" href="{{route('pucdetails.delete',$pucdetails->id)}}" class="btn btn-inverse" rel="tooltip" title="" data-original-title="Delete"><i class="fa fa-times"></i></a>
                  </td>
                </tr>
                @endforeach
