        ...
        <div class="box box-color orange box-condensed box-bordered">
          <div class="box-title">
            ...
            <div id="add-city-form">
             <form enctype="multipart/form-data" class="well form-horizontal" method="post" action="{{route('pucdetails.store')}}">
              {{csrf_field()}}
                 <div class="card-body " >
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-xl-12" id="mytable1">
                        	<div class="row">
	                            ...
	                            <div class="col-md-4 col-xl-4 mt-2">
	                                ...
	                                <input id="vehicle_no" class="form-control" name="puc_no" value="{{old('puc_no')}}" > 
	                                @error('puc_no')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
			                               <strong>{{ 'Please enter PUC number (in number)' }}</strong>
			                            </span>
			                         @enderror
