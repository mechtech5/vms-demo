                        ...
                        <div class="col-sm-12 col-md-12 col-xl-12" id="mytable1">
		                    ...
		                    <div class="row">
		                    	<div class="col-md-3 col-xl-3 mt-2">
	                                <span style="color: #FF0000;font-size:15px;">*</span><label for="Vehicle No.">Formalities Complete</label>
	                                
	                                <input id="ins_policy_no" checked="true"  class="form-control" name="forms_cmpl" value="{{old('forms_cmpl')}}" > 
	                                @error('forms_cmpl')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
			                               <strong>{{ 'Please enter All India Permit No' }}</strong>
			                            </span>
		                        ...
		                        <div class="col-md-3 col-xl-3 mt-2">
	                                ...
	                                <input id="ins_policy_no" checked="true"  class="form-control" name="forms_start_dt" value="{{old('forms_start_dt')}}" > 
		                        ...
		                        <div class="col-md-3 col-xl-3 mt-2">
	                                ...
	                                <input id="ins_policy_no" checked="true"  class="form-control" name="forms_end_dt" value="{{old('forms_end_dt')}}" > 
	                                @error('forms_end_dt')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
			                               <strong>{{ 'Please enter All India Permit No' }}</strong>
			                            </span>
