        ...
        <div class="box box-color orange box-condensed box-bordered">
          <div class="box-title">
            ...
            <div id="add-city-form">
             <form enctype="multipart/form-data" class="well form-horizontal" method="post" action="{{route('greentax.store')}}">
              {{csrf_field()}}
                 <div class="card-body " >
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-xl-12" id="mytable1">
                        	<div class="row">
	                            ...
	                            <div class="col-md-4 col-xl-4 mt-2">
	                                ...
	                                <input id="vehicle_no" class="form-control" name="greentax_no" value="{{old('greentax_no')}}" > 
	                                @error('greentax_no')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
	                        ...
	                        <div class="row">    
	                            ...
	                            <div class="col-md-3 col-xl-3 mt-2">
	                                ...
	                                <input id="email" name="greentax_amt" class="form-control  " value="{{old('greentax_amt')}}">
	                                @error('greentax_amt')
			                            <span class="invalid-feedback d-block" role="alert">
			                               <strong>{{ 'Please enter greentax amount' }}</strong>
			                            </span>
			                        @enderror
	                            ...
	                            <div class="col-md-3 col-xl-3 mt-2">
	                                ...
	                                <input id="email1" class="form-control datepicker"  name="valid_from" value="{{old('valid_from')}}">
	                                 @error('valid_from')
			                            <span class="invalid-feedback d-block" role="alert">
	                           ...
	                           <div class="col-md-3 col-xl-3 mt-2">
	                                ...
	                                <input id="email1" class="form-control datepicker"  name="valid_till" value="{{old('valid_till')}}">
	                                 @error('valid_till')
			                            <span class="invalid-feedback d-block" role="alert">
	                            ...
	                            <div class="col-md-3 col-xl-3 mt-2">
	                                ...
	                                <input id="email1" class="form-control datepicker" name="update_dt" value="{{old('update_dt')}}">
	                                @error('update_dt')
			                            <span class="invalid-feedback d-block" role="alert">
			                	...
			                	<div class="col-md-3 col-xl-3 mt-2">
                           		...
                           		<div class="col-md-3 col-xl-3 mt-2">
                              	  <span style="color: #FF0000;font-size:15px;">*</span><label for="Engine No">Cheque Date</label>
                               		 ...
                               		 <input id="email1" class="form-control datepicker" name="cpay_dt" name="pay_dt" value="{{old('pay_dt')}}">
                               		  @error('cpay_dt')
			                         <span class="invalid-feedback d-block" role="alert">
			                	...
			                	<div class="col-md-3 col-xl-3 mt-2">
                           		...
                           		<div class="col-md-3 col-xl-3 mt-2">
                              	  <span style="color: #FF0000;font-size:15px;">*</span><label for="Engine No">DD Date</label>
                               		 ...
                               		 <input id="email1" class="form-control datepicker" name="dpay_dt" value="{{old('pay_dt')}}">
                               		  @error('dpay_dt')
			                         <span class="invalid-feedback d-block" role="alert">
			                	...
			                	<div class="col-md-3 col-xl-3 mt-2">
                           		...
                           		<div class="col-md-3 col-xl-3 mt-2">
	                                ...
	                                @error('rpay_dt')
			                         ...
			                         @enderror
                               		 <input id="email1" class="form-control datepicker"  name="rpay_dt" value="{{old('pay_dt')}}">
			                	...
			                	<div class="col-md-3 col-xl-3 mt-2">
                           		...
                           		<div class="col-md-3 col-xl-3 mt-2">
	                                ...
	                                @error('npay_dt')
			                         ...
			                         @enderror
                               		 <input id="email1" class="form-control datepicker" name="npay_dt" value="{{old('npay_dt')}}">
