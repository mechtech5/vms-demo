        ...
        <div class="box box-color orange box-condensed box-bordered">
          <div class="box-title">
            ...
            <div id="add-city-form">
             <form class="well form-horizontal" method="post" action="{{route('filter.store')}}">
              {{csrf_field()}}
                 <div class="card-body " >
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-xl-12" id="mytable1">
                            ...
                            <div class="col-md-4 col-xl-4 mt-2">
                                ...
                                @error('filter_comp')
		                         ...
		                         @enderror
                                <input id="email" name="filter_comp" class="form-control  " value="{{old('filter_comp')}}">
                            ...
                            <div class="col-md-4 col-xl-4 mt-2">
                                ...
                                @error('filter_type')
		                         ...
		                         @enderror
                                <input id="email1" class="form-control  " name="filter_type" value="{{old('filter_type')}}">
