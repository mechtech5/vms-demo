        ...
        <div class="box box-color orange box-condensed box-bordered">
          <div class="box-title">
            ...
            <div id="add-city-form">
             <form class="well form-horizontal" method="post" action="{{route('painting.update',$data->id)}}">
              {{csrf_field()}}
              @method('PATCH')
                 <div class="card-body " >
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-xl-12" id="mytable1">
                            ...
                            <div class="col-md-3 col-xl-3 mt-2">
                                ...
                                <input id="email" name="cabin_color" class="form-control  " value="{{old('cabin_color') ?? $data->cabin_color}}">
                                 @error('cabin_color')
                            ...
                            <div class="col-md-3 col-xl-3 mt-2">
                                ...
                                <input id="email1" class="form-control  " name="body_colo" value="{{old('body_colo') ?? $data->body_colo}}">
                                @error('body_colo')
		                            <span class="invalid-feedback d-block" role="alert">
		                               <strong>{{ $message }}</strong>
		                            </span>
                           ...
                           <div class="col-md-3 col-xl-3 mt-2">
                                ...
                                <input id="email1" class="form-control  " name="interior_color" value="{{old('interior_color') ?? $data->interior_color}}">
                            ...
                            <div class="col-md-3 col-xl-3 mt-2">
                                ...
                                <input id="email1" class="form-control  " name="chasis_color" value="{{old('chasis_color') ?? $data->chasis_color }}">
                                 @error('chasis_color')
		                            <span class="invalid-feedback d-block" role="alert">
		                               <strong>{{ $message }}</strong>
		                            </span>
                            ...
                            <div class="col-md-3 col-xl-3 mt-2">
                                ...
                                <input id="email1" class="form-control datepicker" readonly="true" name="date" value="{{$data->date}} ">
                                @error('date')
		                            <span class="invalid-feedback d-block" role="alert">
		                               <strong>{{ $message }}</strong>
		                            </span>
