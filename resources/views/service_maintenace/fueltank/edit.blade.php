        ...
        <div class="box box-color orange box-condensed box-bordered">
          <div class="box-title">
            ...
            <div id="add-city-form">
             <form class="well form-horizontal" method="post" action="{{route('fueltank.update',$data->id)}}">
              {{csrf_field()}}
              @method('PATCH')
                 <div class="card-body " >
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-xl-12" id="mytable1">
                            ...
                            <div class="col-md-12 col-xl-12 mt-2">
                                ...
                                @error('remarks')
		                         ...
		                         @enderror
                                <textarea id="email1" class="form-control  " name="remarks" value="">{{old('remarks') ?? $data->remrks}}</textarea>
