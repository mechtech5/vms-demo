        ...
        <div class="box box-color orange box-condensed box-bordered">
          <div class="box-title">
            <div class="col-sm-6 col-md-6">
                <h3>UPDATE SPARE COMPANY</h3>

            </div>
            <div class="col-sm-6 col-md-6">
                <a class="btn btn-inverse pull-right" href="{{route('sparecompany.index')}}">Back</a>
            </div>
            <div id="add-city-form">
             <form enctype="multipart/form-data" class="well form-horizontal" method="post" action="{{route('sparecompany.update',$data->id)}}">
              {{csrf_field()}}
              @method('PATCH')
                 <div class="card-body " >
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-xl-12" id="mytable1">
				            ...
				            <div class="row">
	                            ...
	                            <div class="col-md-4 col-xl-4 mt-2">
	                                ...
	                                <textarea id="ins_policy_no" class="form-control" name="comp_desc" value="" >{{old('comp_desc') ?? $data->comp_desc}}</textarea> 
	                                @error('comp_desc')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
