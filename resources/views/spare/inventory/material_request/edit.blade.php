        ...
        <div class="box box-color orange box-condensed box-bordered">
          <div class="box-title">
            ...
            <div id="add-city-form">
             ...
             <form class="well form-horizontal" id="edit_form" method="post" action="{{route('material_request.update',$item_dtl->id)}}"  enctype="multipart/form-data">
              {{csrf_field()}}            
              @method('PATCH') 
                 <div class="card-body " >
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-xl-12" id="mytable1">
                            ...
                            <div class='row'>                         
                            	...
                            	<div class="col-md-4 col-xl-4 mt-2">
	                                ...
	                                <input id="email" name="mtr_no" class="form-control  " value="{{old('mtr_no') ?? $item_dtl->mtr_no}}">
	                                @error('mtr_no')
	                            ...
	                            <div class="col-md-4 col-xl-4 mt-2">
	                                ...
	                                <input id="email" name="mtr_date" class="form-control datepicker" readonly="true" value="{{old('mtr_date') ?? $item_dtl->mtr_date }}">
	                                @error('mtr_date')
			                            <span class="invalid-feedback d-block" role="alert">
                              ...
                              <div class="col-md-4 col-xl-4 mt-2">
                                  ...
                                  <input id="email" name="prep_by" class="form-control  " value="{{old('prep_by') ?? $item_dtl->prep_by }}">
                                  @error('prep_by')
                                  <span class="invalid-feedback d-block" role="alert">
    											            ...
    											            <tr >
          										            ...
          										            <tr>
            										            <td style=" width:5% padding-left: 20px;">
		                                                			<?php if($data['not'] != 'not'){ ?>
			                                                			<a style="cursor: pointer;color: #ff0000" data="{{$id}}" id="trash">
			                                                				<i style="margin-right: 5px; " class="fas fa-trash" aria-hidden="true"></i>
			                                                			</a>
			                                                		<?php } ?>	
		                                              			</td>
													            ...
													            <td style=" width:25%; padding-left: 20px"><input {{$data['readonly'] == 'readonly' ? 'readonly':''}} class="form-control qty" value="{{ $data['qty'] }}" type="number" name="qty[]" ></td>
													            <td style=" width:25%; padding-left: 20px"><input {{$data['readonly'] == 'readonly' ? 'readonly':''}} class="form-control" type="text" value="{{$data['remarks']}}" name="remark[]"></td>
