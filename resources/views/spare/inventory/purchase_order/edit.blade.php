        ...
        <div class="box box-color orange box-condensed box-bordered">
          <div class="box-title">
            ...
            <div id="add-city-form">
             <form class="well form-horizontal" method="post" id="create_form1" action="{{route('purchase_order.update',$po_data->id )}}">
              {{ csrf_field() }}
              @method('PATCH')
                 <div class="card-body " >
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-xl-12" id="mytable1">               
                            <div class='row'>        
                            	<div class="col-md-4 col-xl-4 mt-2">
	                                ...
	                                <input id="email" name="po_no" class="form-control  " value="{{old('po_no')?? $po_data->po_number}}">
	                                @error('po_no')
	                            ...
	                            <div class="col-md-4 col-xl-4 mt-2">
	                                ...
	                                <input id="email" name="po_date" class="form-control datepicker" readonly="true" value="{{old('mtr_date') ?? $po_data->po_date }}">
	                                @error('po_date')
			                            <span class="invalid-feedback d-block" role="alert">
                                ...
                                <select id="" required="true" name="vendor_code" class="form-control">
				                    ...
				                    @foreach($supplier as $Supplier)
				              	        <option {{ $Supplier->id == $po_data->vendor_code ? 'selected':'' }} value="{{$Supplier->id}}">{{$Supplier->name}}</option>
				                    @endforeach		
				                </select>
                                @error('vendor_code')
                                <span class="invalid-feedback d-block" role="alert">
                            ...
                            <div class="row">
                            	<div class="col-md-4 col-xl-4 mt-2">
	                              ...
	                              <div class="roundedOne">
								      <input value="1" <?php if($po_data->mtr_no){ echo 'checked'; } ?> type="checkbox" name="is_mtr_no" value="None" id="is_mtr" name="check" >
	                            ...
	                            <div class="col-md-4 col-xl-4 mt-2">
	                                ...
	                                <?php
	                                	$po_id = 0;
	                                	$pomtr_no = 'Select..';
	                                	if(!empty($po_data->mtr_no)){
	                                	  $po = App\Models\MaterialRequest::find($po_data->mtr_no); 
	                                	  $po_id    = $po->id ;
	                                	  $pomtr_no = $po->mtr_no ; 	
	                                	}
	                                ?>
	                              	<select id="mtr_no" name="mtr_no" disabled="true" class="form-control">
							      	  <option value="{{$po_id}}">{{$pomtr_no}}</option>
							        </select>
	                                @error('mtr_no')
	                                <span class="invalid-feedback d-block" role="alert">
                                            		...
                                            		@foreach($ids as $id)
                										...
                										@foreach($data1 as $data) 
                                                    		...
                                                    		<input type='hidden' value="{{$data['id']}}" name = "id[]" >
              												...
              												<td style=" width:25%; "><input class="form-control qty" type="number" id="qty_{{$data['id']}}" data-id = '{{$data['id']}}' name="qty[]" value="{{$data['qty']}}" >
              												
              												<input type="hidden" id="pre_id" value="{{$data['id']}}" name="">	
	                                                        ...
	                                                        @error('qty.'.$cc)
		                                                     ...
		                                                     <td style=" width:25%; "><input class="form-control rate" type="text" value="{{ $data['rate'] }}" id="rate_{{$data['id']}}" data-id = '{{$data['id']}}' name="rate[]">
		                                                      ...
		                                                      <td style=" width:25%; "><input readonly="true" class="form-control ac_amt" type="text" id="amt_{{$data['id']}}" value="{{$data['amt']}}" name="amt[]">
		                                                         
		                                                      </td>
		                                                      <td style=" width:25%; "><input class="form-control disc_pct" type="text" 
		                                                      	value="{{$data['disc_pct']}}" data-id = '{{$data['id']}}' id="disc_pct_{{$data['id']}}" name="disc_pct[]">
		                                                      ...
		                                                      <td style=" width:25%; "><input class="form-control disc_amt" type="text" value="{{$data['disc_amt']}}" name="disc_amt[]" readonly="true" id="disc_amt_{{$data['id']}}"></td>
		                                                      <td style=" width:25%; "><input class="form-control igst_pct" type="text" value="{{$data['igst_pct']}}" id="igst_pct_{{$data['id']}}" data-id = '{{$data['id']}}'  name="igst_pct[]">
		                                                      ...
		                                                      <td style=" width:25%; "><input readonly="true" class="form-control igst_amt" id="igst_amt_{{$data['id']}}" type="text" value="{{$data['igst_amt']}}" name="igst_amt[]"></td>
		                                                      
		                                                      <td style=" width:25%; "><input data-id = '{{$data['id']}}' class="form-control cgst_pct" id="cgst_pct_{{$data['id']}}" type="text" value="{{$data['cgst_pct']}}" name="cgst_pct[]">
		                                                      ...
		                                                      <td style=" width:25%; "><input id="cgst_amt_{{$data['id']}}" class="form-control cgst_amt" type="text" readonly="true" value="{{$data['cgst_amt']}}" name="cgst_amt[]"></td>
		                                                      <td style=" width:25%;"><input class="form-control sgst_pct" type="text" value="{{$data['sgst_pct']}}" name="sgst_pct[]" id="sgst_pct_{{$data['id']}}" data-id = '{{$data['id']}}'>
		                                                      ...
		                                                      <td style=" width:25%;"><input class="form-control sgst_amt" type="text" value="{{$data['sgst_amt']}}" name="sgst_amt[]" readonly="true" id="sgst_amt_{{$data['id']}}"></td>
		                                                      <td style=" width:25%;"><input readonly="true" id="net_amt_{{$data['id']}}" class="form-control net_amt" type="text" value="{{$data['net_amt']}}" name="net_amt[]"></td>
              												  <td style=" width:25%;"><input class="form-control" type="text" value="{{$data['remark']}}" name="remark[]"></td>
                                                  			</tr>
                                                  			<?php ++$cc ?>
          										        @endforeach
          										    @endforeach
                ...
                <div class="row">
                   	<div class="col-md-4 col-xl-4 mt-2">
                        ...
                        <input readonly="true" id="total_qty" name='total_qty' class="form-control total" value="{{ $po_data->total_qty }}">
	                    @error('total_qty')
	                        <span class="invalid-feedback d-block" role="alert">
                    ...
                    <div class="col-md-4 col-xl-4 mt-2">
                        ...
                        <input readonly="true"  name='grand_total' id="grand_total" class="form-control" value="{{ $po_data->grand_total }}">
                    </div> 
                    <div class="col-md-4 col-xl-4 mt-2">
                        <label class="" for="Chasis No">Disc. Amount</label>
                        <input readonly="true" id="disc_amt_sum" name='totl_disc_amt' class="form-control" value="{{$po_data->disc_amt }}">
                    </div> 
                </div>
                <div class="row">
                  	<div class="col-md-4 col-xl-4 mt-2">
                    	 <label class="" for="Chasis No">IGST Amount</label>
                    	<input readonly="true" id="igst_amt_sum" name='totl_igst_amt' class="form-control  total" value="{{$po_data->igst_amt }}">
                                                
                    </div>
                   <div class="col-md-4 col-xl-4 mt-2">
                    	 <label class="" for="Chasis No">CGST Amount</label>
                    	<input  id="cgst_amt_sum" readonly="true" name='totl_cgst_amt' class="form-control  total" value="{{$po_data->cgst_amt }}">
                                                
                    </div> 
                    <div class="col-md-4 col-xl-4 mt-2">
                    	 <label class="" for="Chasis No">SGST Amount</label>
                    	<input readonly="true" id="sgst_amt_sum" name='totl_sgst_amt' class="form-control  total" value="{{$po_data->sgst_amt }}">
                  ...
                  <div class="row">
                  	<div class="col-md-4 col-xl-4 mt-2">
                      	...
                      	<input readonly="true " id="net_amt_sum" name='totl_net_amt' class="form-control  total" value="{{ $po_data->net_amt }}">
