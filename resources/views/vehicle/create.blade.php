        ...
        <div class="box box-color orange box-condensed box-bordered">
          <div class="box-title">
            ...
            <div id="add-city-form">
             <form class="well form-horizontal" method="post" action="{{route('vehicle.store')}}">
              {{csrf_field()}}
                 <div class="row">
                  <div class="col-md-2 col-sm-2"></div>
                    ...
                    <div class="col-md-4 col-sm-4">                    
                        <input id="addressLine1" name="vehicle_company" class="form-control"  value="" type="text">
                ...
                <div class="row mt-2">
                  ...
                  <div class="col-md-2 col-sm-2">
                    ...
                    <div class="col-md-4">
                      <input id="addressLine1" name="company_description" class="form-control"  value="" type="text">
