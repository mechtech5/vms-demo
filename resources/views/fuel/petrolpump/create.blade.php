        ...
        <div class="box box-color orange box-condensed box-bordered">
          <div class="box-title">
            ...
            <div id="add-city-form">
             <form enctype="multipart/form-data" class="well form-horizontal" method="post" action="{{route('petrolpump.store')}}">
              {{csrf_field()}}
                 <div class="card-body " >
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-xl-12" id="mytable1">
			                ...
			                <div class="row">    
				             ...
				             <div class="row">
			                    <div class="col-md-4 col-xl-4 mt-2">
	                                ...
	                                <input id="ins_policy_no" class="form-control" name="contact_name" value="{{old('contact_name')}}" > 
	                                @error('contact_name')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
			                    ...
			                    <div class="col-md-4 col-xl-4 mt-2">
	                                ...
	                                <input id="ins_policy_no" class="form-control" name="contact_phonw" value="{{old('contact_phonw')}}" > 
	                                @error('contact_phonw')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
			                               <strong>{{ 'Please enter agent mobile number' }}</strong>
			                            </span>
			                	...
			                	<div class="col-md-4 col-xl-4 mt-2">
	                                ...
	                                <input id="ins_policy_no" class="form-control" name="pump_website" value="{{old('pump_website')}}" > 
	                                @error('pump_website')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
		                    ...
		                    <div class="row">    
		                        <div class="col-md-12 col-xl-12 mt-2">
	                                ...
	                                <textarea id="ins_policy_no" class="form-control" name="note" value="{{old('note')}}" ></textarea> 
	                                @error('note')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
