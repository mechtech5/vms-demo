						...
						<div class="col-md-8 col-sm-8">
		                 ...
		                 <div class="form-group">
		                       ...
		                       <div class="input-group">
		                          ...
		                          <select name="fleet_owner" class="selectpicker form-control">
		                             ...
		                             @foreach($user as $users)
		                                <option <?php if($users->id == $fleet[0]->fleet_owner){ echo 'selected' ;} ?>value="{{$users->id}}">{{$users->name}}</option>
		                             @endforeach     
		                          </select>
		                        </div>
		                         @error('fleet_user')
		                   ...
		                   <div class="form-group">
		                    ...
		                    <div class="col-md-4 inputGroupContainer">
		                       <div class="input-group">
		                          <input id="addressLine1" name="fleet_name" class="form-control"  value="{{$fleet[0]->fleet_name}}" type="text">
		                          @error('fleet_name')
		                  ...
		                  <div class="form-group">
		                    ...
		                    <div class="col-md-4 inputGroupContainer">
		                       <div class="input-group">
		                          <textarea id="addressLine1" name="fleet_desc" class="form-control"  value="" type="text">{{$fleet[0]->fleet_desc}}</textarea>
		                          @error('fleet_desc')
		                            <span class="invalid-feedback d-block" role="alert">
		                               <strong>{{ $message }}</strong>
		                            </span>
